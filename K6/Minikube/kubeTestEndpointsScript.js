...
export function setup() {
    const url = "http://localhost/keycloakservice/api/login";
...
const ORDER_BASE_URL = 'http://localhost/gameorder/api/order';
const GAME_BASE_URL = 'http://localhost/gamecatalog/api/games';
const KEYCLOAK_BASE_URL = 'http://localhost/keycloakservice/api';
...
//     return {
//       "kubeGetOrdersSummary.html": htmlReport(data),
//     };
//   }

//k6 run kubeTestEndpointsScript.js