package com.example.gameorder.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests((auth) ->
                        auth.requestMatchers(HttpMethod.POST, "/api/order/placeorder").hasRole("USER")
                                .requestMatchers(HttpMethod.GET, "/api/order/currentUser").hasAnyRole("ADMIN","USER")
